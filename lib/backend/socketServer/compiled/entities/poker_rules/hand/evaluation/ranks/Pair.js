...
var Pair = /** @class */ (function (_super) {
     ...
     */
    function Pair(hand, pairCards) {
        var _this = _super.call(this, hand.cards.filter(function (card) { return !__spreadArrays(pairCards).includes(card); })) || this;
        _this.pairCards = [];
        /**
         * Beats other rank
         *
        ...
        _this.print = function () {
            return ("Pair: " + _this.pairCards.map(function (card) { return card.print(); }).join(' and ')).trim();
        };
        /**
         * Get pair cards
         *
         * @returns PlayingCard[]
         */
        _this.getCards = function () { return _this.pairCards; };
        _this.score = HandScore_1.HandScore.PAIR;
        _this.pairCards = pairCards;
        return _this;
    }
    /**
     ...
     * @returns number
     */
    Pair.prototype.solve = function (opponent) {
