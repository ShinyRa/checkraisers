...
var HandEvaluation = /** @class */ (function () {
    ...
    HandEvaluation.findScore = function (tableCards, hand) {
    ...
    HandEvaluation.findPair = function (valueScoring) {
        return valueScoring.filter(function (value) { return value.length === 2; }).flat();
    };
    HandEvaluation.findTwoPair = function (valueScoring) {
        return valueScoring.filter(function (value) { return value.length === 2; });
    };
    HandEvaluation.findTrips = function (valueScoring) {
        return valueScoring.filter(function (value) { return value.length === 3; }).flat();
    };
    HandEvaluation.findFlush = function (suitScoring) {
        return suitScoring.filter(function (suit) { return suit.length >= 5; }).flat();
    };
    HandEvaluation.isFlush = function (suitScoring) {
        return suitScoring.find(function (suit) { return suit.length >= 5; }) != null;
    };
    HandEvaluation.hasStraight = function (valueScoring) {
        return _this.findStraight(valueScoring).length > 0;
    };
    HandEvaluation.straightIsFlush = function (valueScoring) {
        return valueScoring.filter(function (card) { return card.getSuit() == valueScoring[0].getSuit(); }).length === 5;
    };
    HandEvaluation.straightIsRoyal = function (valueScoring) {
        return valueScoring.reduce(function (acc, card) { return acc + card.getValue(); }, 0) === 60;
    };
    HandEvaluation.findStraight = function (valueScoring) {
        var straights = [];
    ...
    HandEvaluation.findFullHouse = function (valueScoring) { return [
    ...
    HandEvaluation.findQuads = function (valueScoring) {
        return valueScoring.filter(function (value) { return value.length === 4; }).flat();
    };
    HandEvaluation.createScoringArray = function (enumObject) {
