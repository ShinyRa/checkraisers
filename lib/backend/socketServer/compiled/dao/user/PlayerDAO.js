...
var PlayerDAO = /** @class */ (function (_super) {
    __extends(PlayerDAO, _super);
    function PlayerDAO() {
        var _this = _super.call(this) || this;
        _this.updateChipAmount = function (chips, email) { return __awaiter(_this, void 0, void 0, function () {
            var db, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        db = _a.sent();
                        return [4 /*yield*/, db.findOneAndUpdate({ email: email }, { $set: { chips: chips } }, {
                                upsert: false,
