...
var GameData = /** @class */ (function () {
    function GameData() {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(match && match.rounds.phase === Phase_1.Phase.EVALUATE)) return [3 /*break*/, 2];
                        _a = this.matches;
                        _b = matchName;
                        return [4 /*yield*/, this.newPhase(match)];
                    case 1:
                        _a[_b] = _c.sent();
        ...
        this.newPhase = function (match) { return __awaiter(_this, void 0, void 0, function () {
            var newMatch, i, playerIndex, chipsSpent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(match.rounds.phase === Phase_1.Phase.RIVER)) return [3 /*break*/, 5];
                    ...
                    case 5:
                        if (match.rounds.phase === Phase_1.Phase.EVALUATE) {
