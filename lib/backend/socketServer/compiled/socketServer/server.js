...
var playerDAO = new PlayerDAO_1["default"]();
io.on('connection', function (socket) {
    ...
    socket.on('join-match', function (data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, playerDAO.getProfile(data.email)];
                case 1:
                    userData = _a.sent();
    ...
    socket.on('player-action', function (data) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, gameData.playerAction(data.email, data.matchName, data.action.playerAction, data.action.chips)];
                case 1:
                    _a.sent();
                    io["in"](data.matchName).emit('match-data', gameData.getSpecificMatch(data.matchName));
                    return [2 /*return*/];
    ...
    socket.on('replay-match', function (data) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, gameData.replay(data.matchName)];
                case 1:
                    _a.sent();
                    io["in"](data.matchName).emit('match-data', gameData.getSpecificMatch(data.matchName));
                    return [2 /*return*/];
