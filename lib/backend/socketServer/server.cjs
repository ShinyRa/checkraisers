...
io.on('connection', function (socket) {
    ...
    socket.on('join-match', function (data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Database.getProfile(data.email)];
                case 1:
                    userData = _a.sent();
...
var Database = /** @class */ (function () {
    ...
    var _a;
    _a = Database;
    Database.getProfile = function (email) { return __awaiter(void 0, void 0, void 0, function () {
        var db, user;
    ...
    Database.getCollection = function (collection) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            switch (_b.label) {
    ...
    Database.openDbConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
        var _b, err_1;
    ...
    Database.closeDbConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            try {
                this.client.close();
            }
